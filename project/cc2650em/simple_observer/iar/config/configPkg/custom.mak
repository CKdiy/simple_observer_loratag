...
linker.cmd: package/cfg/app_ble_prm3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_prm3cfg.cmd\)\"$""\"E:/BeelinkerCode/simple_observer_loratag/project/cc2650em/simple_observer/iar/config/configPkg/\1\""' package/cfg/app_ble_prm3.xdl > $@
